...
<div id="edit" style="display: none;">
 <form  action="user-page" method="post" >
 	...
 	<input type="text" name="name" value="${sessionScope.user.name}" minlength="2" pattern="[.a-zA-ZА-Яа-яҐґЇїІіЄє0-9_]{2,}" required/>
 	<br>
 	<label class="fixed-width"><fmt:message key="label.password" /></label>
 	<input type="password" name="password" value="${sessionScope.user.password}" minlength="3" pattern="[a-zA-Z0-9_]{3,}" required />
 ...
 <table >
 	<tr>
 		<th width="120"><fmt:message key="label.activity"/><a href="user-page">Sort</a></th>
 		<th width="120"><fmt:message key="label.category"/></th>
 		<th width="120">
 	        <a href="user-page?usersActSortBy=amount_time"><fmt:message key="label.time"/></a></th>
 		<th width="120"><a href="user-page?usersActSortBy=status"><fmt:message key="label.status"/></a></th>
 		<th width="80"></th>
 	</tr>
