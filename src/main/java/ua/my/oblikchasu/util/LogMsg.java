...
public abstract class LogMsg {
    ...
    public static final String USER_DELETE_FAIL = "Unable to delete user: ";
    ...
    public static final String ACTIVITY_DELETE_FAIL = "Unable to delete activity: ";
    ...
    public static final String ACTIVITY_CATEGORY_DELETED = "Activity category deleted: ";
    public static final String ACTIVITY_CATEGORY_DELETE_FAIL = "Unable to delete category: ";
    ...
    public static final String USERS_ACTIVITY_UPDATED = "Users activity updated: ";
    ...
    public static final String USERS_ACTIVITY_DELETE_FAIL = "Unable to delete users activity: ";
